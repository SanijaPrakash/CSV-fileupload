...
<body>
	...
	<form name="form" method="post" action="read.php" enctype="multipart/form-data">
		...
		<center><input type="submit" id="btnsubmit" class="btnsubmit" name="btnsubmit" value="SUBMIT">&nbsp;&nbsp;&nbsp;&nbsp;<a href="viewallcontact.php?view" id="view" name="view">VIEW-ALL_CONTACT</a></center>
